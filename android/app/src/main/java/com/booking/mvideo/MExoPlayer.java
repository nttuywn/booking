...
public class MExoPlayer implements VideoRendererEventListener {
    ...
    public MExoPlayer(Context context) {
        ...
        final View mVideoView = inflater.inflate(R.layout.mvideo, null, false);
...
//        Uri mp4VideoUri =Uri.parse("http://cbsnewshd-lh.akamaihd.net/i/CBSNHD_7@199302/index_700_av-p.m3u8"); //CNBC
        Uri mp4VideoUri =Uri.parse("https://manifest.googlevideo.com/api/manifest/hls_variant/expire/1585127447/ei/t8t6XrrZMpDi4gLu7oigCA/ip/118.71.224.167/id/Dx5qFachd3A.425/source/yt_live_broadcast/requiressl/yes/hfr/1/maudio/1/vprv/1/go/1/keepalive/yes/fexp/23882513/dover/11/itag/0/playlist_type/DVR/sparams/expire%2Cei%2Cip%2Cid%2Csource%2Crequiressl%2Chfr%2Cmaudio%2Cvprv%2Cgo%2Citag%2Cplaylist_type/sig/ADKhkGMwRQIhAKNlVkzPdFdLfd2Oij_0BJch_QqYs-2knMbiBl6XdlC2AiAco14w--L8EaA9UBXqdXaD9-wlD8aZ8sDTx5zuKooJ6g%3D%3D/file/index.m3u8"); //ABC NEWS
...
////        Uri mp4VideoUri = Uri.parse(Environment.getExternalStorageDirectory().getAbsolutePath()+urimp4);
        ...
        simpleExoPlayerView = mVideoView.findViewById(R.id.player_view);
